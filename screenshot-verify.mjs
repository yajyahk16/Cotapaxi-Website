...
await page.screenshot({ path: 'temporary screenshots/verify-briefing.png' });

await panels[2].click();
await new Promise(r => setTimeout(r, 700));
await page.screenshot({ path: 'temporary screenshots/verify-modeling.png' });
